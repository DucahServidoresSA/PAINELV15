...
--
-- Host: localhost
-- Tempo de geração: 09/06/2019 às 20:32
-- Versão do servidor: 5.5.62-0+deb8u1
-- Versão do PHP: 5.6.40-0+deb8u4
...
(1, 'admin', 'admin', 'Administrador', 'admin@admin.com', NULL, 'www.painelweb.tk');
...
('Sua ID Mercado Pago', 'Seu Token Mercado Pago');
...
(1, 0, 1, 0, 'geral', 'geral', 'Geral', '1', NULL, '(11) 99999-9999', '2019-06-09 20:03:44', 'vpn', 'nao', NULL, NULL, '0614B614C', 0, 0, 0, '', '', '');
...
--
ALTER TABLE `hist_usuario_ssh_online`
MODIFY `id_hist_usrSSH` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
...
--
ALTER TABLE `usuario`
MODIFY `id_usuario` int(60) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `usuario_ssh`
--
ALTER TABLE `usuario_ssh`
MODIFY `id_usuario_ssh` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
